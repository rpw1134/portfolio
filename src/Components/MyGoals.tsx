        ...
        <div className="flex w-[55%] flex-col justify-center space-y-10">
          ...
          <div className="space-y-8">
            <p className="font-garamond text-3xl font-light leading-relaxed text-white/95">
              Build durable systems, ship products that help people, and keep
              learning.
            </p>
            <p className="font-lato text-xl font-light leading-relaxed text-white/70">
              Near-term, I want to deepen my chops in distributed systems,
              developer tooling, and production-grade AI/ML. Longer-term, I aim
              to lead teams that deliver accessible, reliable software with
              measurable impact—while contributing to the open-source
