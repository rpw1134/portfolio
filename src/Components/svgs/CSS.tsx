export default function CSSSVG() {
  return (
    ...
    >
      ...
      <path
        fill="#2965F1"
        d="M405.388 431.408 440.536 37.678H256v435.146z"
      />
      <path
        fill="#EBEBEB"
      ...
      <path
        fill="#fff"
        d="M255.805 208.59v56.517H325.4l-6.56 73.299-63.035 17.013v58.8l115.864-32.112.85-9.549 13.28-148.792 1.38-15.176 10.203-114.393H255.805v56.518h79.639l-5.144 56.875z"
      />
    </svg>
  );
}
